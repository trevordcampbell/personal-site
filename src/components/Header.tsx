          ...
          >
            ...
            <nav className="mt-6">
              <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                ...
                {/* <MobileNavItem href="/museum">Museum</MobileNavItem> */}
                <MobileNavItem href="/borrow-my-brain">Borrow My Brain</MobileNavItem>
                <MobileNavItem href="/gallery">Photo Gallery</MobileNavItem>
  ...
  return (
    <nav {...props}>
      <ul className="flex whitespace-nowrap rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        ...
        {/* <NavItem href="/museum">Museum</NavItem> */}
        <NavItem href="/borrow-my-brain">Borrow My Brain</NavItem>
...
function AvatarContainer({ className, ...props }: {className?: string, href?: any, style?: any, children?: any}) {
  return (
    <div
      className={clsx(
        className,
...
export function Header() {
  ...
  useEffect(() => {
    ...
    updateStyles()
    window.addEventListener('scroll', updateStyles, options)
    window.addEventListener('resize', updateStyles)

    return () => {
      window.removeEventListener('scroll', updateStyles, options)
