...
export function LegendDisclosure() {
  return (
    <div className="group bg-zinc-50 rounded-2xl border border-zinc-300 p-6 dark:bg-zinc-800 dark:border-zinc-700/40 hover:bg-teal-50 hover:border-teal-400 dark:hover:bg-teal-400/10 hover:dark:border-teal-400">
