...
export default function DetailsModalTesting({ modalData, open, setOpen }: { modalData: any, open: boolean, setOpen: any}) {
  // const [selectedColor, setSelectedColor] = useState(product.colors[0])
  // const [selectedSize, setSelectedSize] = useState(product.sizes[2])

  const [selectedImage, setSelectedImage] = useState(product.otherImages[0])
                ...
                <div className="relative flex w-full items-center overflow-hidden bg-white px-4 pt-14 pb-8 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                  ...
                  <div className="grid w-full grid-cols-1 items-start gap-y-8 gap-x-6 sm:grid-cols-12 lg:items-center lg:gap-x-8">
                    ...
                    <div className="sm:col-span-4 lg:col-span-5">
                      ...
                      <div className="mt-2">
                        <h4 className="text-sm font-medium text-gray-900">Other Images</h4>
                        <RadioGroup value={selectedImage} onChange={setSelectedImage} className="mt-2">
                                ...
                                className={({ active, checked }) =>
                                  classNames('group cursor-pointer focus:outline-none',
                                    ...
                                    checked
                                      ...
                                      : 'text-gray-900 hover:bg-teal-600',
                    ...
                    <div className="sm:col-span-8 lg:col-span-7">
                      <h2 className="text-xl font-medium text-gray-900 sm:pr-12">{modalData.title}</h2>
                      ...
                      <section aria-labelledby="information-heading" className="mt-1">
                        ...
                        <p className="font-medium text-gray-900">{modalData.geography}</p>
