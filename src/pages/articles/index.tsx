...
export default function ArticlesIndex({ articles }: {articles: any}) {
  return (
    <>
      <Head>
        <title>Articles - Trevor Campbell</title>
        <meta
          name="description"
          content="All of my long-form thoughts on life, work, tinkering projects, product design, and more collected in chronological order."
        />
      </Head>
      <SimpleLayout
        title="Writing on whatever ideas have infected my mind... ✏️"
